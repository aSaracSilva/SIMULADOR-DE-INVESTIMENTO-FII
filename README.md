...
Este projeto consiste no desenvolvimento de uma planilha em Excel para simulação de investimentos em fundos imobiliários (FIIs), permitindo ao usuário analisar o crescimento patrimonial ao longo do tempo a partir de aportes mensais e rendimento periódico.
